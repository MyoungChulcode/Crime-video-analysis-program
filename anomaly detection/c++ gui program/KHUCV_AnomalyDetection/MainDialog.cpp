	...
	m_SequenceRunTimer(this, ID_TIMER_SEQUENCE_RUN), m_VideoRunTimer(this, ID_TIMER_VIDEO_RUN), m_CamRunTimer(this, ID_TIMER_CAM_RUN)
{
	...
	m_pListCtrl = new wxListCtrl(this, IDC_FILE_LIST_CTRL, wxDefaultPosition, wxSize(320, 150), wxLC_REPORT | wxLC_SINGLE_SEL | wxSUNKEN_BORDER);
	...
	m_pRunButton = new wxButton(this, IDC_RUN, wxT("Run"), wxDefaultPosition, wxSize(145, 20));
	m_pPauseButton = new wxButton(this, IDC_PAUSE, wxT("Pause"), wxDefaultPosition, wxSize(25, 20));
	m_pHbox[5]->Add(m_pRunButton, 1, wxLEFT, 5);
	m_pHbox[5]->Add(m_pPauseButton, 1, wxLEFT, 5);
...
void CMainDialog::OnTimer(wxTimerEvent & event) {
	...
	if (bLoaded) {
		...
		// Project Run;
		m_Project.Run(CurrentImage, Output, m_bFirstRun, m_pVerboseCheck->GetValue(), m_TotalFrameCnt, m_nProcessingNum);
		m_bFirstRun = false;
